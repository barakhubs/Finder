    ...
    $.fn.passwordStrength = function (options) {
        ...
        $(this).keyup(function (event) {
            ...
            if (password.length == 0) {
                ...
                if (score < 50) {
                    $('#password-score').html('Weak password <span className="icofont-exclamation-tringle"></span>');
                    ...
                    $('#password-score').html('Normal password <span className="icofont-check"></span>');
                    ...
                    $('#password-score').html('Strong password <span className="icofont-check"></span>');
                    ...
                    $('#password-score').html('Very strong password <span className="icofont-check"></span>');
                    $('#password-recommendation').html('');
                    $('#password-progress').removeClass();
